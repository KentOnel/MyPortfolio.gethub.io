   ...
   <section id="about">
      ...
      <div class="row">
         ...
         <div class="three columns">
            <img class="profile-pic"  src="<?php echo validate_image($_settings->userdata('avatar'))  ?>" alt="" />
         ...
         <div class="nine columns main-col">
            ...
            <div class="row">
               ...
               <div class="columns download">
                  <p>
                     <a target="_blank" href="uploads/OneleMondayKennethCV.pdf" class="button"><i class="fa fa-download"></i>Download Resume</a>
                  </p>
               </div>
            ...
            <div class="ten columns flex-container">
               ...
               <div class="flexslider">
                  ...
                  <ul class="slides">
                     ...
                     <li>
                        <blockquote>
                           <p>I had the pleasure of working with Kenneth on a complex web development project, and I couldn't 
                              be more impressed with his expertise and dedication. He took the time to understand our needs 
                              and delivered a solution that exceeded our expectations. His ability to seamlessly integrate front-end 
                              and back-end technologies resulted in a smooth and user-friendly application. Kenneth's professionalism 
                              and attention to detail made the entire process enjoyable and stress-free. I highly recommend him for any web development project.
                           </p>
                     ...
                     <li>
                        <blockquote>
                           <p>Kenneth is an outstanding web developer who truly cares about his clients' success. 
                              He transformed our outdated website into a modern, responsive, and highly functional platform. 
                              His technical skills are top-notch, and his creativity brought our vision to life in ways we hadn't 
                              imagined. Kenneth's communication and project management skills ensured that we were always on the same page, 
                              and he delivered the project on time and within budget.
                              We are thrilled with the results and look forward to working with him again in the future.
                           </p>
                           <cite>Mr. Adobe</cite>
                        </blockquote>
                     </li> <!-- slide ends -->
